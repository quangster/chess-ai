...
export default function ChessBoard() {
    ...
    const makeAMove = (move) => {
        ...
        const isValidMove = moves.some((m) => m.from === move.from && m.to === move.to);
